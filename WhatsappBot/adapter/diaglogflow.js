...
const verificarArchivoDialogflow = () => {
...
const detectarIntencion = async (queryText) => {
    let media = null;
    ...
    const responses = await sessionClient.detectarIntencion(request);
...
const obtenerDataIA = (message = '', cb = () => { }) => {
    detectarIntencion(message).then((res) => {
        cb(res)
    })
}

verificarArchivoDialogflow();

module.exports = { obtenerDataIA }
